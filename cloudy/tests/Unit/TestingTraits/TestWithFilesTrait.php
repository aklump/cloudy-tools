...
trait TestWithFilesTrait {
  ...
  public function createMirrorOfBashTestStubDirectory() {
    $this->getTestFileFilepath('tests/stubs/alpha.txt', TRUE);
    $this->getTestFileFilepath('tests/stubs/bravo.txt', TRUE);
    $charlie = $this->getTestFileFilepath('tests/stubs/charlie.md', TRUE);
    file_put_contents($charlie, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.' . "\n");
  }
}
